...
class Llama2HF(AbstractLanguageModel):
    ...
    def __init__(
        self, config_path: str = "", model_name: str = "llama2-7b-hf", cache: bool = False
    ) -> None:
        """
        ...
        :param model_name: Specifies the name of the LLaMA model variant. Defaults to "llama2-7b-hf".
...
class Llama3HF(AbstractLanguageModel):
    """
    An interface to use LLaMA 3 models through the HuggingFace library.
    """

    def __init__(
        self, config_path: str = "", model_name: str = "llama3-8b-hf", cache: bool = False
    ) -> None:
        """
        Initialize an instance of the Llama3HF class with configuration, model details, and caching options.

        :param config_path: Path to the configuration file. Defaults to an empty string.
        :type config_path: str
        :param model_name: Specifies the name of the LLaMA model variant. Defaults to "llama3-8b-hf".
                           Used to select the correct configuration.
        :type model_name: str
        :param cache: Flag to determine whether to cache responses. Defaults to False.
        :type cache: bool
    ...
    def query(self, query: str, num_responses: int = 1) -> List[Dict]:
        """
        Query the LLaMA 3 model for responses.

        :param query: The query to be posed to the language model.
        :type query: str
        :param num_responses: Number of desired responses, default is 1.
        :type num_responses: int
        :return: Response(s) from the LLaMA 3 model.
        :rtype: List[Dict]
        """
        if self.cache and query in self.response_cache:
            return self.response_cache[query]
